...
class BrowserManager:
    ...
    def get_saucelabs_browser(self, browsername, rversion, scenario_name, site, webdriver=None):
        # If no webdriver is provided, import Selenium's webdriver
        ...
        if browsername == 'sauce_desktop':
            ...
            driver = appium_webdriver.Remote(command_executor=sauce_url, options=CAPS)
            ...
            caps = {
                ...
                'sauce:options': {
                    'username': sauce_user,
                    'accessKey': sauce_key,
                    'build': f'Android_Tunnel_{rversion}',
                    'name': f'{scenario_name} for {site}',
                    'deviceOrientation': 'PORTRAIT',
