...
class PropertiesReader:
    ...
    def get_section(self, section):
        ...
        return PropertiesSection(self.config, section)
...
# test
# config_properties = PropertiesReader("config\config.properties")
# database = config_properties.get_section('DATABASE_DETAILS')
# print(database)
# database_name = database.get_key('DATABASE_NAME')
# print(database_name)
# sauce = config_properties.get_section('SAUCELABS_CRED')
# print(sauce)
...
class JsonConfigReader:
    ...
    def get_section(self, section):
        ...
        return JsonSection(self.config, section)
